...
#define UE_PROJECT_NAME Strategy_Pattorn
#define UE_TARGET_NAME Strategy_PattornEditor
#define UE_MODULE_NAME "Strategy_Pattorn"
...
#define STRATEGY_PATTORN_API DLLEXPORT
